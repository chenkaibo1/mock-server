...
本项目主要是通过<a href="https://www.tslang.cn" target="_blank">Typescript</a>、<a href="http://nodejs.cn/api/" target="_blank">nodejs</a>对<a href="https://easy-mock.com" target="_blank">Easy Mock</a>进行重构，主要是为了熟悉通过在nodejs项目中使用<a href="https://www.tslang.cn" target="_blank">Typescript</a>,此仓库为server，搭配<a href="https://github.com/chenkaibo1/mock-client.git" target="_blank">mock-client</a>一起使用
...
```sh
$ git clone https://github.com/chenkaibo1/mock-server.git
$ cd mock-client && yarn
